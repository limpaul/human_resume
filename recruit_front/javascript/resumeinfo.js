...
<ul>
    <li><b>대학</b></li>
    <li>
        <select id="degreeType${gloIdUniv}">
...
<ul>
    <li><b>학교명</b><b></b></li>
    <li><input id="univname${gloIdUniv}" type="text"></li>
</ul>
<ul>
    <li><b>지역</b></li>
    <li>
...
<ul>
    <li><b>재학기간</b></li>
    <li>
        <input id="sc_start${gloIdUniv}" type="date">
        <input id="sc_end${gloIdUniv}" type="date">
    </li>
</ul>
<ul>
    <li><b>전공</b></li>
    <li><input id="major${gloIdUniv}" type="text"></li>
</ul>
<ul>
    <li><b>학점</b></li>
    <li><input id="score${gloIdUniv}" type="text"></li>
</ul>
<ul>
<li><b>졸업여부</b></li>
<li>
    <select id="gradu${gloIdUniv}">
...
<ul>
<li><b>취득일</b></li>
<li><input id="cert_date${gloIdCert}" type="date"></li>
</ul>
<ul>
<li><b>자격증명</b><b></b></li>
